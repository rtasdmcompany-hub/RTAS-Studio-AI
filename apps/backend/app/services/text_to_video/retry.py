"""Retry policy for Text-to-Video provider requests."""
...
def next_delay_seconds(
    ...
    *,
    ...
    pol = policy or DEFAULT_RETRY_POLICY
    # attempts is count of finished tries; next delay uses that count
...
def mark_for_retry(
    ...
    *,
    ...
    """Increment attempts and decide whether to retry. Mutates request."""
    request.attempts += 1
    request.error = error
