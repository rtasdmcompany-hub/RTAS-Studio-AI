"""Anthropic Claude connector adapter."""
...
class ClaudeConnector(BaseProviderConnector):
    provider_id = "claude"
    display_name = "Anthropic Claude"
    version = "1.0.0-connector"
    capabilities = ("text", "vision", "translation", "embedding")
    default_priority = 15
    ...
    async def _invoke(self, request: StandardRequest) -> StandardResponse:
        ...
        return StandardResponse(
            ...
            data={
                ...
                "message": "Claude connector ready (live invoke deferred)",
