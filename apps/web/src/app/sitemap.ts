...
const INDEXABLE_PATHS: Array<{
  ...
  { path: "/updates", changeFrequency: "weekly", priority: 0.55 },
  { path: "/careers", changeFrequency: "monthly", priority: 0.55 },
  { path: "/beta", changeFrequency: "weekly", priority: 0.8 },
  ...
  { path: "/partners/resources", changeFrequency: "monthly", priority: 0.55 },
  ...
  { path: "/feedback", changeFrequency: "weekly", priority: 0.55 },
  { path: "/status", changeFrequency: "daily", priority: 0.5 },
  { path: "/launch", changeFrequency: "weekly", priority: 0.75 },
  { path: "/launch/campaigns", changeFrequency: "weekly", priority: 0.65 },
  { path: "/launch/assets", changeFrequency: "monthly", priority: 0.6 },
